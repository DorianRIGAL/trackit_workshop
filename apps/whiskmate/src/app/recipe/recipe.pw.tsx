  ...
  recipes: [
    {
      ...
      description:
        'A simple and delicious pasta dish with a creamy tomato basil sauce.',
      pictureUrl:
    ...
    },
    {
      ...
      description:
        "A classic comfort food that's easy to make and always satisfying.",
      pictureUrl:
        'https://mylifecookbook.com/wp-content/uploads/2022/11/chili-quesadilla-closeupSQ.jpg',
      steps: [
    ...
    },
    {
      ...
      description:
        'These savory potato pancakes are a delicious and easy-to-make appetizer or side dish. They are made with simple ingredients that you probably already have on hand.',
      pictureUrl:
        'https://therecipecritic.com/wp-content/uploads/2021/02/potatopancakeshero.jpg',
      steps: [
    ...
    },
    {
      ...
      description:
        "A classic pizza recipe that's always a crowd-pleaser. Made with a simple dough, homemade tomato sauce, fresh mozzarella cheese, and basil, this pizza is sure to satisfy your cravings.",
      pictureUrl:
        'https://ohsweetbasil.com/wp-content/uploads/four-cheese-margherita-pizza-recipe-12-scaled-1400x2100.jpg',
      steps: [
    ...
    },
    {
      ...
      name: 'Tartiflette',
      description:
        'A traditional French dish made with potatoes, Reblochon cheese, and lardons.',
      pictureUrl:
        'https://img.taste.com.au/VqLW9HQ7/w720-h480-cfill-q80/taste/2017/06/tartiflette-127553-1.jpg',
      steps: [
...
test('Recipe component', async ({ mount }) => {
  const component = await mount(<Recipe {...fakeRecipes.recipes[0]} />);

  await expect(component).toContainText(fakeRecipes.recipes[0].name);
  await expect(component).toContainText(fakeRecipes.recipes[0].description);
});
